...
/*
IllegalArgumentException: wrong_name.txt must start with 'file_'
IllegalArgumentException: file_nonexistent.txt doesn't exist
IllegalArgumentException: file_empty.txt is empty
[wubba lubba dub dub]
 */