...
/*
IllegalArgumentException: s must not be empty, is []
IllegalArgumentException: s must not be blank, is [   ]
IllegalArgumentException: s must contain 3 parts separated by '-', is [abcdef]
IllegalArgumentException: s must contain 3 parts separated by '-', is [-abcdef-]
IllegalArgumentException: s must contain 3 parts separated by '-', is [-abc-def-]
ab-cd-ef
