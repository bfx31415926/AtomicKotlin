...
98.0
0.0
IllegalArgumentException: quantity must be > 0, is -1.0
IllegalArgumentException: quantity must be > 0, is -7.0
IllegalArgumentException: drain exceeds tank amount: 1.0
 */